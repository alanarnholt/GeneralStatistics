...
The above `R` code creates a file named `packages.bib` to cite the `ggplot2` package used to create Figure \@ref(fig:HISTO).  Figure \@ref(fig:HISTO) was created with `ggplot2` by @R-ggplot2. To cite a package in the `*.bib` file, use the syntax `@name_of bib_entry`.  This document specifies the output as `bookdown::html_document2`.  The function `bookdown::html_document2` is from `bookdown` written by @R-bookdown.
